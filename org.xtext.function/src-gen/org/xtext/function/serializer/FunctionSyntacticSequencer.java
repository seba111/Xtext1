...
public class FunctionSyntacticSequencer extends AbstractSyntacticSequencer {

	protected FunctionGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (FunctionGrammarAccess) access;
