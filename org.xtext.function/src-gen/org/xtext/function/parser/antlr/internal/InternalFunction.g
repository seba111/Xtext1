...
@parser::members {
    ...
    public InternalFunctionParser(TokenStream input, FunctionGrammarAccess grammarAccess) {
        this(input);
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getElementsStartParserRuleCall_0()); 
	    }
		lv_elements_0_0=ruleStart		{
	        if ($current==null) {
...
((	otherlv_0='(' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getStartAccess().getLeftParenthesisKeyword_0_0());
    }

    { 
        newCompositeNode(grammarAccess.getStartAccess().getExpWithDefinitionsParserRuleCall_0_1()); 
    }
    this_ExpWithDefinitions_1=ruleExpWithDefinitions
    { 
        $current = $this_ExpWithDefinitions_1.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_2=')' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getStartAccess().getRightParenthesisKeyword_0_2());
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getStartAccess().getFunctionCallParserRuleCall_1()); 
    }
...
entryRuleExpWithDefinitions returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getExpWithDefinitionsRule()); }
	 iv_ruleExpWithDefinitions=ruleExpWithDefinitions 
	 { $current=$iv_ruleExpWithDefinitions.current; } 
	 EOF 
;

// Rule ExpWithDefinitions
ruleExpWithDefinitions returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    { 
        newCompositeNode(grammarAccess.getExpWithDefinitionsAccess().getExpParserRuleCall_0()); 
    }
    this_Exp_0=ruleExp
    { 
    ...
    |
    { 
        newCompositeNode(grammarAccess.getExpWithDefinitionsAccess().getVariableDefinitionParserRuleCall_1()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getExpWithDefinitionsAccess().getFunctionDefinitionParserRuleCall_2()); 
    }
...
(((	ruleMathFunction)=>
    { 
        newCompositeNode(grammarAccess.getExpAccess().getMathFunctionParserRuleCall_0()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getExpAccess().getExpressionParserRuleCall_1()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionAccess().getOpArithmeticOperationParserRuleCall_0_0_0()); 
	    }
		lv_op_0_0=ruleArithmeticOperation		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionAccess().getLeftTerminalExpressionParserRuleCall_0_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionAccess().getRightTerminalExpressionParserRuleCall_1_0()); 
	    }
...
((	otherlv_0='(' 
    ...
    { 
        newCompositeNode(grammarAccess.getTerminalExpressionAccess().getExpParserRuleCall_0_1()); 
    }
    this_Exp_1=ruleExp
    { 
...
(
	...
	otherlv_3=RULE_NAME
	{
		newLeafNode(otherlv_3, grammarAccess.getTerminalExpressionAccess().getVariableVariableDefinitionCrossReference_1_0()); 
	}
    ...
    |(
(
		lv_value_4_0=RULE_DOUBLE
		{
			newLeafNode(lv_value_4_0, grammarAccess.getTerminalExpressionAccess().getValueDOUBLETerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getTerminalExpressionRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getTerminalExpressionAccess().getFunctioncallFunctionCallParserRuleCall_3_0()); 
	    }
		lv_functioncall_5_0=ruleFunctionCall		{
	        if ($current==null) {
...
entryRuleArithmeticOperation returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getArithmeticOperationRule()); } 
	 iv_ruleArithmeticOperation=ruleArithmeticOperation 
	 { $current=$iv_ruleArithmeticOperation.current.getText(); }  
	 EOF 
;

// Rule ArithmeticOperation
ruleArithmeticOperation returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getArithmeticOperationAccess().getPlusSignKeyword_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getArithmeticOperationAccess().getHyphenMinusKeyword_1()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getArithmeticOperationAccess().getSolidusKeyword_2()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getArithmeticOperationAccess().getAsteriskKeyword_3()); 
    }
)
    ;
...
(
    { 
        newCompositeNode(grammarAccess.getMathFunctionAccess().getMathTwoArgParserRuleCall_0()); 
    }
    this_MathTwoArg_0=ruleMathTwoArg
    { 
        $current = $this_MathTwoArg_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getMathFunctionAccess().getMathOneArgParserRuleCall_1()); 
    }
    this_MathOneArg_1=ruleMathOneArg
    { 
        $current = $this_MathOneArg_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleMathTwoArg returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMathTwoArgRule()); }
	 iv_ruleMathTwoArg=ruleMathTwoArg 
	 { $current=$iv_ruleMathTwoArg.current; } 
	 EOF 
;

// Rule MathTwoArg
ruleMathTwoArg returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgAccess().getFunctionTwoArgFunctionParserRuleCall_0_0_0()); 
	    }
		lv_function_0_0=ruleTwoArgFunction		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgRule());
	        }
       		set(
       			$current, 
       			"function",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgAccess().getLeftTerminalExpressionParserRuleCall_0_1_0()); 
	    }
		lv_left_1_0=ruleTerminalExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgAccess().getRightTerminalExpressionParserRuleCall_1_0()); 
	    }
		lv_right_2_0=ruleTerminalExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgRule());
...
entryRuleMathOneArg returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMathOneArgRule()); }
	 iv_ruleMathOneArg=ruleMathOneArg 
	 { $current=$iv_ruleMathOneArg.current; } 
	 EOF 
;

// Rule MathOneArg
ruleMathOneArg returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getMathOneArgAccess().getFunctionOneArgFunctionParserRuleCall_0_0()); 
	    }
		lv_function_0_0=ruleOneArgFunction		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathOneArgRule());
	        }
       		set(
       			$current, 
       			"function",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathOneArgAccess().getLeftTerminalExpressionParserRuleCall_1_0()); 
	    }
		lv_left_1_0=ruleTerminalExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathOneArgRule());
...
entryRuleTwoArgFunction returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getTwoArgFunctionRule()); } 
	 iv_ruleTwoArgFunction=ruleTwoArgFunction 
	 { $current=$iv_ruleTwoArgFunction.current.getText(); }  
	 EOF 
;

// Rule TwoArgFunction
ruleTwoArgFunction returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getTwoArgFunctionAccess().getMaxKeyword_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getTwoArgFunctionAccess().getMinKeyword_1()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getTwoArgFunctionAccess().getPowKeyword_2()); 
    }
)
    ;
...
entryRuleOneArgFunction returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getOneArgFunctionRule()); } 
	 iv_ruleOneArgFunction=ruleOneArgFunction 
	 { $current=$iv_ruleOneArgFunction.current.getText(); }  
	 EOF 
;

// Rule OneArgFunction
ruleOneArgFunction returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOneArgFunctionAccess().getSqrtKeyword_0()); 
    }
...
(	otherlv_0='define' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getVariableDefinitionAccess().getDefineKeyword_0());
    }
(
(
...
(
		lv_number_2_0=RULE_DOUBLE
		{
			newLeafNode(lv_number_2_0, grammarAccess.getVariableDefinitionAccess().getNumberDOUBLETerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getVariableDefinitionRule());
...
(	otherlv_0='define' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getFunctionDefinitionAccess().getDefineKeyword_0());
    }
	otherlv_1='(' 
    {
...
(
		...
		{
			newLeafNode(lv_name_2_0, grammarAccess.getFunctionDefinitionAccess().getNameNAMETerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionDefinitionAccess().getParametersParameterParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionDefinitionAccess().getExpExpInFunParserRuleCall_6_0()); 
	    }
		lv_exp_6_0=ruleExpInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFunctionDefinitionRule());
	        }
       		set(
...
(
(
		lv_name_0_0=RULE_PARAMNAME
		{
			newLeafNode(lv_name_0_0, grammarAccess.getParameterAccess().getNamePARAMNAMETerminalRuleCall_0()); 
		}
		{
	        if ($current==null) {
...
(	otherlv_0='(' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getFunctionCallAccess().getLeftParenthesisKeyword_0());
    }
	otherlv_1='call' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getFunctionCallAccess().getCallKeyword_1());
    }
(
(
		{
	...
	otherlv_2=RULE_NAME
	{
		newLeafNode(otherlv_2, grammarAccess.getFunctionCallAccess().getFuncFunctionDefinitionCrossReference_2_0()); 
	}
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionCallAccess().getParamvaluesParamValuesParserRuleCall_3_0()); 
	    }
		lv_paramvalues_3_0=ruleParamValues		{
	        if ($current==null) {
...
entryRuleParamValues returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getParamValuesRule()); }
	 iv_ruleParamValues=ruleParamValues 
	 { $current=$iv_ruleParamValues.current; } 
	 EOF 
;

// Rule ParamValues
ruleParamValues returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		...
		{
			newLeafNode(lv_value_0_0, grammarAccess.getParamValuesAccess().getValueDOUBLETerminalRuleCall_0_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getParamValuesRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"value",
...
(
	...
	otherlv_1=RULE_NAME
	{
		newLeafNode(otherlv_1, grammarAccess.getParamValuesAccess().getVariableVariableDefinitionCrossReference_1_0()); 
	}
...
entryRuleExpInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getExpInFunRule()); }
	 iv_ruleExpInFun=ruleExpInFun 
	 { $current=$iv_ruleExpInFun.current; } 
	 EOF 
;

// Rule ExpInFun
ruleExpInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((	ruleMathFunctionInFun)=>
    { 
        newCompositeNode(grammarAccess.getExpInFunAccess().getMathFunctionInFunParserRuleCall_0()); 
    }
    this_MathFunctionInFun_0=ruleMathFunctionInFun
    { 
        $current = $this_MathFunctionInFun_0.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getExpInFunAccess().getExpressionInFunParserRuleCall_1()); 
    }
    this_ExpressionInFun_1=ruleExpressionInFun
    { 
        $current = $this_ExpressionInFun_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleExpressionInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getExpressionInFunRule()); }
	 iv_ruleExpressionInFun=ruleExpressionInFun 
	 { $current=$iv_ruleExpressionInFun.current; } 
	 EOF 
;

// Rule ExpressionInFun
ruleExpressionInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionInFunAccess().getOpArithmeticOperationParserRuleCall_0_0_0()); 
	    }
		lv_op_0_0=ruleArithmeticOperation		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExpressionInFunRule());
	        }
       		set(
       			$current, 
       			"op",
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionInFunAccess().getLeftTerminalExpressionInFunParserRuleCall_0_1_0()); 
	    }
		lv_left_1_0=ruleTerminalExpressionInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExpressionInFunRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpressionInFunAccess().getRightTerminalExpressionInFunParserRuleCall_1_0()); 
	    }
		lv_right_2_0=ruleTerminalExpressionInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExpressionInFunRule());
	        }
       		add(
...
entryRuleTerminalExpressionInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTerminalExpressionInFunRule()); }
	 iv_ruleTerminalExpressionInFun=ruleTerminalExpressionInFun 
	 { $current=$iv_ruleTerminalExpressionInFun.current; } 
	 EOF 
;

// Rule TerminalExpressionInFun
ruleTerminalExpressionInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='(' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTerminalExpressionInFunAccess().getLeftParenthesisKeyword_0_0());
    }

    { 
        newCompositeNode(grammarAccess.getTerminalExpressionInFunAccess().getExpInFunParserRuleCall_0_1()); 
    }
    this_ExpInFun_1=ruleExpInFun
    { 
        $current = $this_ExpInFun_1.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_2=')' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getTerminalExpressionInFunAccess().getRightParenthesisKeyword_0_2());
    }
)
    |(
(
		...
		{
			newLeafNode(lv_value_3_0, grammarAccess.getTerminalExpressionInFunAccess().getValueDOUBLETerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getTerminalExpressionInFunRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"value",
...
(
	...
	otherlv_4=RULE_PARAMNAME
	{
		newLeafNode(otherlv_4, grammarAccess.getTerminalExpressionInFunAccess().getParameterParameterCrossReference_2_0()); 
	}
...
entryRuleMathFunctionInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMathFunctionInFunRule()); }
	 iv_ruleMathFunctionInFun=ruleMathFunctionInFun 
	 { $current=$iv_ruleMathFunctionInFun.current; } 
	 EOF 
;

// Rule MathFunctionInFun
ruleMathFunctionInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    { 
        newCompositeNode(grammarAccess.getMathFunctionInFunAccess().getMathTwoArgInFunParserRuleCall_0()); 
    }
    this_MathTwoArgInFun_0=ruleMathTwoArgInFun
    { 
        $current = $this_MathTwoArgInFun_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getMathFunctionInFunAccess().getMathOneArgInFunParserRuleCall_1()); 
    }
    this_MathOneArgInFun_1=ruleMathOneArgInFun
    { 
        $current = $this_MathOneArgInFun_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleMathTwoArgInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMathTwoArgInFunRule()); }
	 iv_ruleMathTwoArgInFun=ruleMathTwoArgInFun 
	 { $current=$iv_ruleMathTwoArgInFun.current; } 
	 EOF 
;

// Rule MathTwoArgInFun
ruleMathTwoArgInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgInFunAccess().getFunctionTwoArgFunctionParserRuleCall_0_0_0()); 
	    }
		lv_function_0_0=ruleTwoArgFunction		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgInFunRule());
	        }
       		set(
       			$current, 
       			"function",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgInFunAccess().getLeftTerminalExpressionInFunParserRuleCall_0_1_0()); 
	    }
		lv_left_1_0=ruleTerminalExpressionInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgInFunRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathTwoArgInFunAccess().getRightTerminalExpressionInFunParserRuleCall_1_0()); 
	    }
		lv_right_2_0=ruleTerminalExpressionInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathTwoArgInFunRule());
...
entryRuleMathOneArgInFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMathOneArgInFunRule()); }
	 iv_ruleMathOneArgInFun=ruleMathOneArgInFun 
	 { $current=$iv_ruleMathOneArgInFun.current; } 
	 EOF 
;

// Rule MathOneArgInFun
ruleMathOneArgInFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getMathOneArgInFunAccess().getFunctionOneArgFunctionParserRuleCall_0_0()); 
	    }
		lv_function_0_0=ruleOneArgFunction		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathOneArgInFunRule());
	        }
       		set(
       			$current, 
       			"function",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMathOneArgInFunAccess().getLeftTerminalExpressionInFunParserRuleCall_1_0()); 
	    }
		lv_left_1_0=ruleTerminalExpressionInFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMathOneArgInFunRule());
...
entryRuleIfType returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getIfTypeRule()); } 
	 iv_ruleIfType=ruleIfType 
	 { $current=$iv_ruleIfType.current.getText(); }  
	 EOF 
;

// Rule IfType
ruleIfType returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getIfTypeAccess().getEqualKeyword_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getIfTypeAccess().getLessKeyword_1()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getIfTypeAccess().getGreaterKeyword_2()); 
    }
)
    ;
