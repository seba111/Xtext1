...
* generated by Xtext
*/
package org.xtext.function.ui.contentassist.antlr;
...
public class FunctionParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.function.ui.contentassist.antlr.internal.InternalFunctionParser createParser() {
		org.xtext.function.ui.contentassist.antlr.internal.InternalFunctionParser result = new org.xtext.function.ui.contentassist.antlr.internal.InternalFunctionParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMathTwoArgAccess().getGroup(), "rule__MathTwoArg__Group__0");
					put(grammarAccess.getMathTwoArgAccess().getGroup_0(), "rule__MathTwoArg__Group_0__0");
					...
					put(grammarAccess.getExpressionAccess().getOpAssignment_0_0(), "rule__Expression__OpAssignment_0_0");
					put(grammarAccess.getExpressionAccess().getLeftAssignment_0_1(), "rule__Expression__LeftAssignment_0_1");
					...
					put(grammarAccess.getMathOneArgAccess().getFunctionAssignment_0(), "rule__MathOneArg__FunctionAssignment_0");
					put(grammarAccess.getMathOneArgAccess().getLeftAssignment_1(), "rule__MathOneArg__LeftAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.function.ui.contentassist.antlr.internal.InternalFunctionParser typedParser = (org.xtext.function.ui.contentassist.antlr.internal.InternalFunctionParser) parser;
